...
# this is a decorator function, it essentially 'wraps' the function below it with itself. in this case, a user must be logged in to see this function execute.
@login_required
def special(request):
    return HttpResponse("Sweet, you're logged in !")
